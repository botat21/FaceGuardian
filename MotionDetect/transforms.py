...
class GroupRandomCrop:
    ...
    def __call__(self, img_tuple):
        ...
        # Apply random crop to each image in the group
        cropped_images = [img.crop((x1, y1, x1 + target_width, y1 + target_height)) if (width, height) != (target_width, target_height) else img for img in img_group]
